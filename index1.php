...
<body class="body-bg">
                            ...
                            <nav>
                                <ul id="nav_menu">
                                    ...
                                    <li class="active">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="index.html">API CONFIG</a></li>
            ...
            <div class="container">
                <div class="row">
                                ...
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="fa-solid fa-wheelchair"></i> Rawat Jalan</div>
                                            <h2 id="countRawatJalan">0</h2>
                                        </div>
                            ...
                            <div class="col-md-6 mt-md-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="fa-solid fa-bed"></i></i> Rawat Inap</div>
                                            <h2 id="countRawatInap">0</h2>
                                        </div>
                    ...
                    <div class="col-lg-4 mt-5">
                        <div class="card">
                            <div class="card-body pb-0">
                                <h4 class="header-title">Kunjungan Rawat Inap</h4>
                    ...
                    <div class="col-lg-8 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Monitoring Bridging BPJS Via CDN</h4>
                                <div style="">

                                    <iframe src="html_bridging.php" style="overflow: hidden;
  position: relative;
  text-align: left;
  width: 839px;
  height: 350px;
  ...
  touch-action: none;"></iframe>
                    ...
                    <div class="col-xl-8 col-lg-8 mt-5">
                        <!-- <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Data Klaim</h4>
        ...
        <footer>
            <div class="footer-area">
                <p>© Copyright <?php echo date("Y-m-d"); ?>. All right reserved. Template by <a href="https://colorlib.com/wp/">Colorlib</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
